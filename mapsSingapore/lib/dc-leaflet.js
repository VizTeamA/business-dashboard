    ...
    dc.baseMapChart = function (_chart) {
        ...
        var _tiles = function (map) {
            L.tileLayer(
                ...
                {
                    attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors , &copy; <a href="http://www.data.gov.sg">Data.gov.sg</a>'
                }
            ).addTo(map);
        };
        ...
        var processFeatures = function (feature, layer) {
            ...
            if (v && v.d) {
                ...
                if (_chart.renderPopup()) {
					...
					//adopted from http://stackoverflow.com/questions/31790830/d-undefined-for-d3-tip-tooltip-with-dc-leafletchoroplethchart/34613413
					layer.bindTooltip(_chart.popup()(v.d, feature));
					layer.on('click', function (e) { _chart.map().fitBounds(e.target.getBounds()); });
                }
...
(function () {
    ...
    if (dc.leafletChoroplethChartMarkers) {
        return false;
    }

    dc.leafletChoroplethChartMarkers = function (parent, chartGroup) {
        var _chart = dc.colorChart(dc.baseLeafletChart({}));
		...
		//Start adding variables from Marker Chart
