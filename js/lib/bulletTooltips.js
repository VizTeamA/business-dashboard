...
d3.bullet = function() {
  ...
  function bullet(g) {
    g.each(function(d, i) {
      ...
      if (wrap.empty()) wrap = g.append("g")
                                .attr("class", "wrap")
                                .on("click",function() {
                                  toggleSelectColor(wrap);
                                });
      ...
      range.enter().append("rect")
          ...
          .attr("height", extentY)
          .attr("x", reverse ? x0 : 0)
          //.on("mouseover",function(d){console.log("range click d="+d +" i=" + i)})
          .append("svg:title")
          .text(function(d, i) {
            var toolTipString ="";
            if (i==0) {
...
//Hack in and customize Zen, Duong
      ...
      marker.enter().append("line")
          ...
          //.on("mouseover",function(d){console.log("range click d="+d +" i=" + i)})
          .append("svg:title")
          .text(function(d) { return "Target Sales: " + d; });
...
function toggleSelectColor(container) {
